...
golem::fill_desc(
  pkg_name = "r_regex_tester_app", # The Name of the package containing the App 
  pkg_title = "R Regex Tester", # The Title of the package containing the App 
  pkg_description = "Shiny application that provides R users an application to test/check regular expression query in R.", # The Description of the package containing the App 
  author_first_name = "Adam", # Your First Name
  author_last_name = "Spannbauer",  # Your Last Name
  author_email = "SpanbauerAdam@gmail.com",      # Your Email
